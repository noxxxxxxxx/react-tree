<template><div><h1 id="教程" tabindex="-1"><a class="header-anchor" href="#教程" aria-hidden="true">#</a> 教程</h1>
<h2 id="快速入门" tabindex="-1"><a class="header-anchor" href="#快速入门" aria-hidden="true">#</a> 快速入门</h2>
<div class="custom-container tip"><p class="custom-container-title">前提条件</p>
<ul>
<li>熟悉 React 和 Redux 语法</li>
<li>已安装 16.0 或更高版本的 Node.js</li>
</ul>
</div>
<h3 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h3>
<p>根据你的包管理工具，选择下列任意一项命令执行。</p>
<p>使用 NPM:</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>使用 Yarn:</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>使用 PNPM:</p>
...
<p>将 <code v-pre>figma-tree</code> 组件导入，设置数据和默认参数并进行渲染。</p>
